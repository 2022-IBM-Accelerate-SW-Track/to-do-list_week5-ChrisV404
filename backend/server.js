...
//** week5, get all items from the json database*/
  function getItems (request, response) {
    var data = fs.readFileSync('database.json'); // read in todo lists stored in database.json file
    
    response.json(JSON.parse(data));  // return data from the file (parsed as JSON file)
  } 
